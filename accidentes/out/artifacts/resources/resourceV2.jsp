    ...
    <div class="row">
        <div class="col-3">
            <div class="list-group justify-content-start">
                ...
                <a href="http://biciaccidentes.es:8080/app/resource/accidentType" class="list-group-item list-group-item-action" style="height: 50px;width: 300px;">accident type</a>
